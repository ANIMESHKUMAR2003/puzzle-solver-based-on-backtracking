...
class TangramGame(TangramSolver):
    ...
    def draw_start_state(self):
        ...
        instructions_text5 = NUM_ITERATIONS_FONT.render(f"NP-hard complexity!!", True, (0, 0, 0))
        instructions_rect5 = instructions_text4.get_rect()
        instructions_rect5.center = (SCREEN_WIDTH / 2, SCREEN_HEIGHT / 3 + 300)
